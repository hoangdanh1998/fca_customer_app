  ...
  const confirmCode = (code) => {
    try {
      ...
      firebase
        ...
        .then((result) => {
          dispatch(registerAccount({ numberPhone, password }, newAccount.name));
            ...
            <View style={styles.formContainer}>
              ...
              >
                {isShowButton ? (
                  ...
                  >
                    <Text
                      style={[
                        [
                          styles.title,
                          { marginRight: 5, color: "#004777", marginTop: 4 },
                        ],
                      ]}
                    >
                      {" "}
                  ...
                  <Text
                    style={[[styles.title, { marginRight: 5, marginTop: 4 }]]}
                  >
                    {" "}
                    Gửi lại sau
                  </Text>
                ...
                >
                  {({ remainingTime, animatedColor }) => {
                    return (
                      <Animated.Text
                        style={{ color: animatedColor, fontSize: 20 }}
                      >
                        {remainingTime}
                      </Animated.Text>
                    );
