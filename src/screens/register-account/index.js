...
export default function RegisterAccountScreen(props) {
    ...
    const checkPassword = (password) => {
        ...
        if (!password.match(passReg)) {
            setPasswordErr("Mật khẩu phải có ít nhất 8 kí tự, phải chứa chữ in hoa, chữ số");
            return false;
        } else {
            return true;
        }
    ...
    const handleRegisterAccount =
        (
            ...
            if (isNumberPhone && isPassword && isName
                && isConfirmPass
            ) {
                ...
                <ScrollView style={{ backgroundColor: PRIMARY_LIGHT_COLOR }}>
                    <View style={styles.container}>
                        ...
                        <View>
                            ...
                            <View style={{ ...styles.inputForm, marginTop: 20, width: "58%" }}>
                                <Feather
                                    name="phone"
                                    color={DARK_COLOR}
                                    size={25}
                                />
                                <Text style={[styles.titleText, styles.codePhone]}>
                                    +84
                                    </Text>
                                <TextInput
