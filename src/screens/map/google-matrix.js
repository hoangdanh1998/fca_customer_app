...
const GoogleMatrix = () => {
  ...
  const google_APIUrl =
    `https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=10.8277609,106.6793874&destinations=10.8224989,106.6880843&key=${KEY_GGMAP}`;
  // "&origin="
  // "&destination="
  // "&key="${KEY_GGMAP}
